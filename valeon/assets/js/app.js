...
$(function() {
    ...
    $('.results-slider').slick({
      ...
      slidesToShow: 1,
      slidesToScroll: 1,
      prevArrow: '<button type="button" class="slick-prev"><img src="assets/img/arrows/prev.svg"></button>',
      nextArrow: '<button type="button" class="slick-next"><img src="assets/img/arrows/next.svg"></button>'
    });
